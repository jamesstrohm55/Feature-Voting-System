            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="h-11 w-full rounded-lg border border-gray-300 px-3 pr-10 text-sm text-slate-900 placeholder-slate-400 transition-colors duration-150 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
                />
                <button
                  type="button"
